...
また、スマホゲーム開発は規模が大きい分、担当する範囲が生まれてくる。Frontend / Designer / Backend / Infra / Planner / Debugger / Marketer … etc。小規模なWebサービスならフルスタックと言われる技量を持っている人なら3役くらいは兼任できたりするが、スマホゲームでは多くても2つとかなので、完全にチームでの開発が必須となる。
...
前職はSIerで国際決済に関する会社の業務を行っていたが、ここのジャンルが国際決済の中でもかなりニッチで日本でも2社しか取り扱っていないようなもので、大手のメガバンについてはほぼその会社が独占している状態だった。尖っているからこそハマれば強いが、逆に潰しが利かないなどの特性があるニッチ戦略というものについては理解していて、SI→Web業界の途中でのキャリアチェンジにあたり、この戦略を取った。

結論、求めていた技術のポジションを勝ち取ってアサインされ、業務を通してかなり学べたし、それに対しての気付きという点でも有意義な副産物としてのメリットを得られた。ここでの技術のジャンルは正確にはニッチではエッジだった。

- Web技術職でのニッチとメインストリーム
...
- エッジ技術とは
  ...
  ニッチ技術が需要と供給の母数が少ない技術だとすると、エッジ技術は年齢が若い技術だと考えるとわかりやすい。他にも、導入実績が少ない分ナレッジが少ない・そもそもエッジ技術が一般的に広がるかは運の要素もある・機能アップデートに対する変更が破壊的なケースが多いのでアプリケーションへのメンテコストとキャッチアップコストが高い、などが挙げられる。

- エッジ技術を追う技術
  ニッチを知るのと同様にエッジ技術を知るにはリソースが限りなく少ないので、積極的に自分から追いに行かないといけない。具体的には、当たり前だがオリジナルのドキュメントから始まり、ドキュメントに記述がないものはコードを直接見るし、FW／言語の今後の方針とかナレッジについてはカンファレンスでの発表内容を中心にして知識の集め方を学べた。もちろん全部英語なので、英語だけで情報収集し続けたのも有り自分の英語力（笑）も少しは上がったような気にはなる。また、社内では神のようなフルスタックなテックリードが一人居て、この人が数少なくエッジを追える人なので、会社レベルでの新しい技術選定という意味合いでもこの人が会社の技術を引っ張っていたようなに見える。

というわけで、自分がニッチ技術だと思っていたものがエッジ技術でした、という話。
...
- 楽しい
  ...
  個人的な感想だがエッジ追うの楽しい。追加される機能は基本的に技術トレンド的にモダンなので、有用なものが多いしワクワクできる。
...
　「エッジを攻めるエンジニア」
という方向性で自分の成長を進めていきたいな、という方針を建てられたのは良かった。



## まとめ

というわけで、入社するときの願望に対して一通り実現できたわけだ。また、それによって、自分の方向性として、
...
あたりが、やりたい今後の方向性という点もわかったので、具体的に何をやっていくか落とし込んで行きたい。
...
また、社長との距離感はやはり近い。ただ、最近は会社がIPOの準備に入り（オープンにして良い情報です）、会社を組織化していくフェーズに入ったこともあり、自分が入社した時期ほど、近くはなくなった感もある。
...
もともとSE畑かつ自分が理屈屋なところもあり、良くも悪くも更にロジカルな思考が強くなってしまった。更には一時期は「マウント取るマン」になってしまい、論理正当性という免罪符を基に論理破綻している相手や論理武装が弱い相手をボコボコに殴ってしまっていた点は反省すべき点だと思う。端的に言えば論破が目的になっていた感がある。
